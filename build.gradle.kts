...
val malilibVersion: String = when {
    ...
    sc.current.parsed >= "26.1.2" -> "26.1.2:0.28.9"
    ...
    sc.current.parsed >= "1.20.1" -> "1.20.1:0.16.3"
    sc.current.parsed >= "1.19.4" -> "1.19.4:0.15.4"
    sc.current.parsed >= "1.19.3" -> "1.19.3:0.14.1-pre.1"
    sc.current.parsed >= "1.19.2" -> "1.19.2:0.13.0"
    sc.current.parsed >= "1.19" -> "1.19:0.13.0"
    sc.current.parsed >= "1.18.2" -> "1.18.2:0.12.1"
    ...
    sc.current.parsed >= "1.16.4" -> "1.16.4:0.10.0-dev.21+arne.8"
    sc.current.parsed >= "1.16.3" -> "1.16.3:0.10.0-dev.21+arne.1"
    sc.current.parsed >= "1.16.2" -> "1.16.2:0.10.0-dev.21+arne.2"
    sc.current.parsed >= "1.16.1" -> "1.16.1:0.10.0-dev.21+arne.2"
    sc.current.parsed >= "1.16" -> "1.16:0.10.0-dev.21+beta.2"
    sc.current.parsed >= "1.15.2" -> "1.15.2:0.10.0-dev.21+arne.3"
    sc.current.parsed >= "1.15.1" -> "1.15.1:0.10.0-dev.20+beta.2"
    sc.current.parsed >= "1.15" -> "1.15:0.10.0-dev.20+beta.3"
    sc.current.parsed >= "1.14.4" -> "1.14.4:0.10.0-dev.20+arne.2"
    sc.current.parsed >= "1.14.3" -> "1.14.3:0.10.0-dev.20"
    sc.current.parsed >= "1.14.2" -> "1.14.2:0.10.0-dev.20"
    sc.current.parsed >= "1.14" -> "1.14:0.10.0-dev.19"
    else -> throw IllegalStateException()
}
